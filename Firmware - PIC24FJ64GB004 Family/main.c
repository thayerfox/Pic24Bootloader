...
void BlinkUSBStatus(void)
{
    ...
    #define mLED_Both_Off()         {mLED_Off();}
    #define mLED_Both_On()          {mLED_On();}
    #define mLED_Only_1_On()        {mLED_On();}
    #define mLED_Only_2_On()        {mLED_Off();}
    ...
    if(USBSuspendControl == 1)
    {
        ...
        {
            mLED_Toggle();
            //mSetLED_2(mLED);        // Both blink at the same time
        }//end if
    }
    else
    {
        ...
        else if(USBDeviceState == CONFIGURED_STATE)
        {
            ...
            {
                mLED_Toggle();
                //mSetLED_2(!mLED);       // Alternate blink
            }//end if
        }//end if(...)
