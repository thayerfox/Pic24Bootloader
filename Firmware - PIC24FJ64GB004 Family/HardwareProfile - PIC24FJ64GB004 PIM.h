...
#define HARDWARE_PROFILE_PIC24FJ64GB004_PIM_H
    ...
    /** LED ************************************************************/
    #define mInitAllLEDs()      TRISBbits.TRISB8 = 0; LATBbits.LATB8 = 0;
    ...
    #define mSetLED(in)       mLED = in
    
    /** SWITCH *********************************************************/
    #define mBootloaderSwitch() AD1PCFGbits.PCFG4 = 1; TRISBbits.TRISB2 = 1;
    #define mInitAllSwitches()  mBootloaderSwitch();
    #define swBootloader        PORTBbits.RB2
